    ...
    IProxyEventAggregator eventAggregator) : ITaskSolution
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        const string publicUrl = "https://tmhcb-85-221-137-135.a.free.pinggy.link";
        ...
        var proxyEventCancellation = new CancellationTokenSource(TimeSpan.FromSeconds(20));

        try
        {
            await foreach (var proxyEvent in eventAggregator.Subscribe(sessionId, proxyEventCancellation.Token))
